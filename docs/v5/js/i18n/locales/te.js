...
export default {
  ...
  'support.cta.privacy': 'ఈ లింక్ కొత్త ట్యాబ్‌లో బయటి సైట్‌ను (ఉదాహరణకు Buy Me a Coffee) తెరుస్తుంది. ఈ పరికరాన్ని ఏదైనా వదిలి వెళ్లే ఏకైక క్షణం అదే — కొలత మాత్రం ఎప్పుడూ ఇక్కడే ఉంటుంది.',
  'support.cta.privacyFuture': 'చిరునామా అమరిన తర్వాత, ఆ బటన్ కొత్త ట్యాబ్‌లో బయటి సైట్‌ను (ఉదాహరణకు Buy Me a Coffee) తెరుస్తుంది. ఈ పరికరాన్ని ఏదైనా వదిలి వెళ్లే ఏకైక క్షణం అదే అవుతుంది — కొలత మాత్రం ఎప్పుడూ ఇక్కడే ఉంటుంది.',
