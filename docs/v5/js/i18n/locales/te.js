...
export default {
  ...
  'measure.intro.honesty': 'ఇది వైద్య పరికరమూ కాదు, పరీక్షా కాదు. చుట్టూ ఉన్న వెలుతురు ఎలా ఉందో యాప్ సుమారుగా చూపిస్తుంది; ఆరోగ్యంపై తీర్పు ఇవ్వదు, వైద్యుడితో మాట్లాడటానికి ప్రత్యామ్నాయమూ కాదు.',
  ...
  'tools.about.privacyPolicy': 'పూర్తి గోప్యతా విధానం',
  ...
  'metric.flicker.help': 'చౌక డిమ్మర్లు, బ్యాక్‌లైట్లు కొట్టుకుంటాయి. కన్ను దాన్ని చూడదు, కానీ అలసటకు, తలనొప్పికి అది ఒక సంభావ్య కారణంగా చెబుతారు.',
  ...
  'camera.error.denied': 'కెమెరా వాడేందుకు అనుమతి రాలేదు. మీ బ్రౌజర్ లేదా సిస్టమ్ సెట్టింగ్‌లలో ఈ పేజీకి కెమెరాను అనుమతించి మళ్లీ ప్రయత్నించండి.',
