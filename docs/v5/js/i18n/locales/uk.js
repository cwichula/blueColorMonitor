...
export default {
  ...
  'support.cta.privacy': 'Це посилання відкриває зовнішній сайт (наприклад, Buy Me a Coffee) у новій вкладці. Це єдиний момент, коли щось залишає цей пристрій — саме вимірювання завжди залишається тут.',
  'support.cta.privacyFuture': 'Коли адреса з’явиться, кнопка відкриватиме зовнішній сайт (наприклад, Buy Me a Coffee) у новій вкладці. Це буде єдиний момент, коли щось залишає цей пристрій — саме вимірювання завжди залишається тут.',
