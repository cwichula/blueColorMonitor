...
export default {
  ...
  'measure.intro.honesty': 'Це не медичний виріб і не обстеження. Застосунок показує наближення того, яке світло довкола, не виносить суджень про здоровʼя і не заміняє розмову з лікарем.',
  ...
  'tools.about.privacyPolicy': 'Повна політика конфіденційності',
  ...
  'camera.error.denied': 'Немає дозволу на доступ до камери. Дозвольте камеру для цієї сторінки у налаштуваннях браузера або системи й спробуйте ще раз.',
