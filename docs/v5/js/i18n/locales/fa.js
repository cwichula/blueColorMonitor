...
export default {
  ...
  'measure.intro.honesty': 'این وسیلهٔ پزشکی یا آزمایش نیست. برنامه تقریبی از نور پیرامون شما نشان می‌دهد، دربارهٔ سلامتی داوری نمی‌کند و جای گفت‌وگو با پزشک را نمی‌گیرد.',
  ...
  'tools.about.privacyPolicy': 'سیاست کامل حریم خصوصی',
  ...
  'metric.flicker.help': 'دیمرها و نورهای پس‌زمینهٔ ارزان تپش دارند. چشم آن را نمی‌بیند، اما آن را از علت‌های احتمالی خستگی و سردرد می‌دانند.',
  ...
  'camera.error.denied': 'اجازهٔ دسترسی به دوربین داده نشد. در تنظیمات مرورگر یا سیستم، دوربین را برای این صفحه مجاز کنید و دوباره تلاش کنید.',
