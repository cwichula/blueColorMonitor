...
export default {
  ...
  'support.cta.privacy': 'این پیوند یک سایت بیرونی (مثلاً Buy Me a Coffee) را در زبانهٔ تازه‌ای باز می‌کند. این تنها لحظه‌ای است که چیزی از این دستگاه بیرون می‌رود — خودِ اندازه‌گیری همیشه همین‌جا می‌ماند.',
  'support.cta.privacyFuture': 'وقتی نشانی گذاشته شود، دکمه یک سایت بیرونی (مثلاً Buy Me a Coffee) را در زبانهٔ تازه‌ای باز می‌کند. آن تنها لحظه‌ای خواهد بود که چیزی از این دستگاه بیرون می‌رود — خودِ اندازه‌گیری همیشه همین‌جا می‌ماند.',
