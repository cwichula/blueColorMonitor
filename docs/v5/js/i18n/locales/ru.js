...
export default {
  ...
  'measure.intro.honesty': 'Это не медицинское изделие и не обследование. Приложение показывает приближение того, каков свет вокруг, не выносит суждений о здоровье и не заменяет разговор с врачом.',
  ...
  'tools.about.privacyPolicy': 'Полная политика конфиденциальности',
  ...
  'support.cta.privacy': 'Эта ссылка открывает внешнюю страницу Buy Me a Coffee в новой вкладке. Это единственный момент, когда что-либо покидает это устройство — само измерение всегда остаётся здесь.',
  'support.cta.privacyFuture': 'Когда адрес появится, кнопка будет открывать внешнюю страницу Buy Me a Coffee в новой вкладке. Это будет единственный момент, когда что-либо покидает это устройство — само измерение всегда остаётся здесь.',
  ...
  /* Interfejs nigdy nie pokazuje err.message: to teksty przeglądarki, bez rady,
     ...
     rady. */
  'camera.error.denied': 'Нет разрешения на доступ к камере. Разрешите камеру для этой страницы в настройках браузера или системы и попробуйте снова.',
