...
export default {
  ...
  'tools.thresholds.subtitle': 'Από ποια τιμή και πάνω η εφαρμογή θα λέει «μέτριο» και από ποια «επιβλαβές». Τα προεπιλεγμένα κατώφλια είναι δική μας πρόταση, όχι πρότυπο — ρυθμίστε τα όπως σας ταιριάζει.',
  ...
  'support.cta.privacy': 'Αυτός ο σύνδεσμος ανοίγει εξωτερικό ιστότοπο (για παράδειγμα το Buy Me a Coffee) σε νέα καρτέλα. Είναι η μόνη στιγμή που κάτι φεύγει από αυτή τη συσκευή — η ίδια η μέτρηση μένει πάντα εδώ.',
  'support.cta.privacyFuture': 'Όταν εμφανιστεί η διεύθυνση, το κουμπί θα ανοίγει εξωτερικό ιστότοπο (για παράδειγμα το Buy Me a Coffee) σε νέα καρτέλα. Θα είναι η μόνη στιγμή που κάτι φεύγει από αυτή τη συσκευή — η ίδια η μέτρηση μένει πάντα εδώ.',
  ...
  'metric.flicker.help': 'Οι φθηνοί ροοστάτες και οι οπίσθιοι φωτισμοί πάλλονται. Το μάτι δεν το βλέπει, αλλά είναι γνωστή αιτία κόπωσης και πονοκεφάλου.',
  ...
  'camera.error.denied': 'Δεν δόθηκε άδεια πρόσβασης στην κάμερα. Επιτρέψτε την κάμερα για αυτή τη σελίδα στις ρυθμίσεις του προγράμματος περιήγησης και δοκιμάστε ξανά.',
