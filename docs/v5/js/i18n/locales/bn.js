...
export default {
  ...
  'tools.thresholds.subtitle': 'কোন মান থেকে অ্যাপ “মাঝারি” বলবে, আর কোনটি থেকে “ক্ষতিকর”। ডিফল্ট সীমাগুলো আমাদের প্রস্তাব, কোনো মানদণ্ড নয় — নিজের মতো করে ঠিক করে নিন।',
  ...
  'support.cta.privacy': 'এই লিংক নতুন ট্যাবে একটি বাইরের সাইট খোলে (যেমন Buy Me a Coffee)। এই ডিভাইস থেকে কিছু বেরোয় কেবল ওই মুহূর্তেই — পরিমাপ নিজে সব সময় এখানেই থাকে।',
  'support.cta.privacyFuture': 'ঠিকানাটি যুক্ত হলে বোতামটি নতুন ট্যাবে একটি বাইরের সাইট খুলবে (যেমন Buy Me a Coffee)। এই ডিভাইস থেকে কিছু বেরোনোর সেটিই হবে একমাত্র মুহূর্ত — পরিমাপ নিজে সব সময় এখানেই থাকে।',
  ...
  'metric.flicker.help': 'সস্তা ডিমার ও ব্যাকলাইট স্পন্দিত হয়। চোখ তা দেখে না, তবু এটি ক্লান্তি ও মাথাব্যথার পরিচিত কারণ।',
  ...
  'camera.error.denied': 'ক্যামেরা ব্যবহারের অনুমতি দেওয়া হয়নি। ব্রাউজারের সেটিংসে এই পৃষ্ঠার জন্য ক্যামেরা চালু করে আবার চেষ্টা করুন।',
