...
export default {
  ...
  'support.cta.privacy': 'ลิงก์นี้จะเปิดเว็บไซต์ภายนอก (เช่น Buy Me a Coffee) ในแท็บใหม่ นั่นเป็นช่วงเวลาเดียวที่มีอะไรออกไปจากอุปกรณ์นี้ — ตัวการวัดเองยังอยู่ที่นี่เสมอ',
  'support.cta.privacyFuture': 'เมื่อมีที่อยู่แล้ว ปุ่มนี้จะเปิดเว็บไซต์ภายนอก (เช่น Buy Me a Coffee) ในแท็บใหม่ นั่นจะเป็นช่วงเวลาเดียวที่มีอะไรออกไปจากอุปกรณ์นี้ — ตัวการวัดเองยังอยู่ที่นี่เสมอ',
