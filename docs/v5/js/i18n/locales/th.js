...
export default {
  ...
  'measure.intro.honesty': 'นี่ไม่ใช่เครื่องมือแพทย์และไม่ใช่การตรวจ แอปแสดงค่าประมาณของแสงรอบตัวคุณเท่านั้น ไม่ได้ตัดสินเรื่องสุขภาพ และไม่ได้แทนที่การปรึกษาแพทย์',
  ...
  'tools.about.privacyPolicy': 'นโยบายความเป็นส่วนตัวฉบับเต็ม',
  ...
  'metric.flicker.help': 'สวิตช์หรี่ไฟและแบ็กไลต์ราคาถูกมักเต้นเป็นจังหวะ ตามองไม่เห็น แต่มีการระบุว่าอาจเป็นสาเหตุหนึ่งของความล้าและอาการปวดหัว',
  ...
  'camera.error.denied': 'ไม่ได้รับอนุญาตให้ใช้กล้อง อนุญาตให้ใช้กล้องกับหน้านี้ในการตั้งค่าเบราว์เซอร์หรือระบบ แล้วลองอีกครั้ง',
