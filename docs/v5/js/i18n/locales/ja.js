...
export default {
  ...
  'support.cta.privacy': 'このリンクは外部のサイト（たとえば Buy Me a Coffee）を新しいタブで開きます。この端末から何かが出るのはその瞬間だけで、測定そのものは常にここに残ります。',
  'support.cta.privacyFuture': 'アドレスが用意できたら、ボタンは外部のサイト（たとえば Buy Me a Coffee）を新しいタブで開きます。この端末から何かが出るのはその瞬間だけで、測定そのものは常にここに残ります。',
