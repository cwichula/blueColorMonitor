...
export default {
  ...
  'support.cta.privacy': 'يفتح هذا الرابط موقعًا خارجيًا (مثل Buy Me a Coffee) في علامة تبويب جديدة. وهذه هي اللحظة الوحيدة التي يغادر فيها شيء هذا الجهاز — أما القياس نفسه فيبقى هنا دائمًا.',
  'support.cta.privacyFuture': 'حين يتوفّر العنوان، سيفتح الزر موقعًا خارجيًا (مثل Buy Me a Coffee) في علامة تبويب جديدة. وستكون تلك هي اللحظة الوحيدة التي يغادر فيها شيء هذا الجهاز — أما القياس نفسه فيبقى هنا دائمًا.',
