...
window.I18nData['ur'] = Object.assign(window.I18nData['ur'] || {}, {
  ...
  'support.serviceText': 'عطیات کا پروفائل کوئی بیرونی سروس چلاتی ہے، مثلاً Buy Me a Coffee۔ ایپ اس سے نہ کوئی اسکرپٹ لیتی ہے، نہ ویجٹ اور نہ تصویر — یہاں صرف ایک سادہ لنک کھڑا ہے، اس کے سوا کچھ نہیں۔',
