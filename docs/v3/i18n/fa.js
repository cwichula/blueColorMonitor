...
window.I18nData['fa'] = Object.assign(window.I18nData['fa'] || {}, {
  ...
  'support.serviceText': 'نمایهٔ کمک مالی را Buy Me a Coffee اداره می‌کند و تنها شکل پشتیبانی در این برنامه همین است. برنامه هیچ اسکریپت، ابزارک یا تصویری از آن بارگذاری نمی‌کند — اینجا فقط یک پیوند ساده ایستاده است و بس.',
